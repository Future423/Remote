...
class Calculator:
    def __init__(self, master):
        ...
        self.screen = Text(master, state='disabled', width=33, height=3)
        self.screen.configure(font=('Arial Black',12,'bold'))
    ...
    def createButton(self,val,write=True,width=7):
        ...
        return Button(self.master, text=val,font=('Arial Black',12,'bold'),bg="azure",command = lambda: self.click(val,write), width=width,height=2)
